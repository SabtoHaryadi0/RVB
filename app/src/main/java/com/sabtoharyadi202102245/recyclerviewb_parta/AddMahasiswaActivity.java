package com.sabtoharyadi202102245.recyclerviewb_parta;
    ...
    private void initSaveButton() {
        ...
        _saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "https://stmikpontianak.net/011100862/tambahMahasiswa.php"+"?nim="+nim+"&nama"+nama+"&jenisKelamin"+jenisKelamin+"&tempatLahir"+tempatLahir+"&tanggalLahir"+tanggalLahir+"&alamat"+alamat+"&jp"+jp+"&statusPernikahan"+statusNikah+"&tahunMasuk"+tahunMasuk;
                Log.d("*tw*", url);
